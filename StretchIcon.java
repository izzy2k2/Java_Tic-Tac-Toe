 ...
 * Copied and pasted from https://gist.github.com/bspkrs/bd4b368204d710256bc7 exactly as user bspkrs posted it
 */
...
public class StretchIcon extends ImageIcon
{
    ...
    public synchronized void paintIcon(Component c, Graphics g, int x, int y)
    {
        ...
        /*
         * Added to generate nicer looking results when scaling. - bspkrs
         * BEGIN CHANGES
         */
